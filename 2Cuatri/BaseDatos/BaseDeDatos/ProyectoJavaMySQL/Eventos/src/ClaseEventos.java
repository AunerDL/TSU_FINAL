...
public class ClaseEventos implements ActionListener, KeyListener{
    
    private JTextField txtDato1, txtDato2, txtResultado;
    private JButton btsuma;
    
    public ClaseEventos(JTextField txtDato1, JTextField txtDato2, JButton btsuma, JTextField txtResultado){
