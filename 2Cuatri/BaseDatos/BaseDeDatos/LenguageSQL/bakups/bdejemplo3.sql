...
--
-- Host: 127.0.0.1    Database: bdejemplo3
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `oficinas_resumen`
--

DROP TABLE IF EXISTS `oficinas_resumen`;
/*!50001 DROP VIEW IF EXISTS `oficinas_resumen`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `oficinas_resumen` AS SELECT 
 1 AS `ciudad`,
 1 AS `Oficina`,
 1 AS `region`*/;
...
INSERT INTO `productos` VALUES ('ACI','41001','Serie 1, cable',55.0000,277),('ACI','41002','Serie 2, cable',76.0000,167),('ACI','41003','Serie 3, cable',7.0000,207),('ACI','41004','Serie 4. cable',117.0000,139),('ACI','4100X','Zapata Grande',25.0000,37),('ACI','4100Y','Zapata Pequeña',2750.0000,25),('ACI','4100Z','Zapata Mediana',2500.0000,28),('BIC','1401','Mesas',78.5000,45),('BIC','41003','Hélice',652.0000,3),('BIC','41089','Retén ',225.0000,78),('BIC','41672','Plato',180.0000,0),('FEA','112','Huso',148.0000,115),('FEA','114','Montura del Motor',243.0000,15),('IMM','773C','30 - kg brazo',975.0000,28),('IMM','775C','50-kg brazo',1425.0000,5),('IMM','779C','90- kg brazo',1875.0000,9),('IMM','887H','Barrilete',54.0000,223),('IMM','887P','Bulón ',250.0000,24),('IMM','887X','Brazo retén ',475.0000,32),('QSA','XK47','Reductora',355.0000,38),('QSA','XK48','Reductora',134.0000,203),('QSA','XK48A','Reducción',177.0000,37),('REI','2A44G','Hilo de Cobre',350.0000,14),('REI','2A44L','Llave',4500.0000,12),('REI','2A44R','Riostra',4500.0000,12),('REI','2A45C','Rueda',79.0000,210);
/*!40000 ALTER TABLE `productos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `reprensentante_este`
--

DROP TABLE IF EXISTS `reprensentante_este`;
/*!50001 DROP VIEW IF EXISTS `reprensentante_este`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `reprensentante_este` AS SELECT 
 1 AS `Num_Empl`,
 1 AS `Nombre`,
 1 AS `Edad`,
 1 AS `Oficina_Rep`,
...
--
-- Temporary view structure for view `reprensentante_oeste`
--

DROP TABLE IF EXISTS `reprensentante_oeste`;
/*!50001 DROP VIEW IF EXISTS `reprensentante_oeste`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `reprensentante_oeste` AS SELECT 
 1 AS `Num_Empl`,
 1 AS `Nombre`,
 1 AS `Edad`,
 1 AS `Oficina_Rep`,
...
--
-- Final view structure for view `oficinas_resumen`
--
...
/*!50001 VIEW `oficinas_resumen` AS select `oficinas`.`Ciudad` AS `ciudad`,`oficinas`.`Oficina` AS `Oficina`,`oficinas`.`Region` AS `region` from `oficinas` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `reprensentante_este`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `reprensentante_este` AS select `representantes`.`Num_Empl` AS `Num_Empl`,`representantes`.`Nombre` AS `Nombre`,`representantes`.`Edad` AS `Edad`,`representantes`.`Oficina_Rep` AS `Oficina_Rep`,`representantes`.`Puesto` AS `Puesto`,`representantes`.`Fecha_Contrato` AS `Fecha_Contrato`,`representantes`.`Jefe` AS `Jefe`,`representantes`.`Cuota` AS `Cuota`,`representantes`.`Ventas` AS `Ventas` from `representantes` where (`representantes`.`Oficina_Rep` in (11,12,13)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `reprensentante_oeste`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `reprensentante_oeste` AS select `representantes`.`Num_Empl` AS `Num_Empl`,`representantes`.`Nombre` AS `Nombre`,`representantes`.`Edad` AS `Edad`,`representantes`.`Oficina_Rep` AS `Oficina_Rep`,`representantes`.`Puesto` AS `Puesto`,`representantes`.`Fecha_Contrato` AS `Fecha_Contrato`,`representantes`.`Jefe` AS `Jefe`,`representantes`.`Cuota` AS `Cuota`,`representantes`.`Ventas` AS `Ventas` from `representantes` where (`representantes`.`Oficina_Rep` in (21,22)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-03-21 13:15:59
