...
public class OperacionesMatricez {
    ...
    public OperacionesMatricez(int filas, int columnas) {
    ...
    public void sumar(OperacionesMatricez otraMatriz) {
    ...
    public void restar(OperacionesMatricez otraMatriz) {
        int filas = matriz.length;
        int columnas = matriz[0].length;
        for (int i = 0; i < filas; i++) {
            for (int j = 0; j < columnas; j++) {
    ...
    public void multiplicar(OperacionesMatricez otraMatriz) {
    ...
    public int sumaDiagonal() {
        ...
        if (filas == columnas) {
            ...
            // En caso de que no sea una matriz cuadrada, devuelve -1 para indicar un error.
            return -1;
        }
