...
import edu.mx.uttt.listasDobles.NodoLista;
...
public class Lista {
    ...
    public void insertarEnfrente(Object elemento) {
        if (estaVacia()) {
            this.primerNodo = this.ultimoNodo = new NodoLista(elemento);
        } else {
            NodoLista nuevoNodo = new NodoLista(elemento, primerNodo, null);
    ...
    public void insertarAlFinal(Object elemento) {
        if (estaVacia()) {
            ...
            NodoLista nuevoNodo = new NodoLista(elemento, null, ultimoNodo);
